	...
	<ul class="fc-toolbar-list-link">
		<li class="froggy-link-toolbar first-floor toolbar-link">
			...
			<ul class="fc-toolbar-submenu">
				<li><a {$froggytoolbarv2.target_link}href="http://www.froggy-commerce.com/">{l s='Froggy Commerce' mod='froggytoolbar'}</a></li>
				<li><a {$froggytoolbarv2.target_link}href="http://addons.prestashop.com/">{l s='PrestaShop Addons' mod='froggytoolbar'}</a></li>
				<li><a {$froggytoolbarv2.target_link}href="http://www.prestashop.com/forums/">{l s='PrestaShop Forum' mod='froggytoolbar'}</a></li>
			</ul>
		</li>
		<li class="backoffice-link-toolbar first-floor toolbar-link"><a {$froggytoolbarv2.target_link}href="{$base_dir}{$froggytoolbarv2.admin_dir}{FroggyGetAdminLink a='AdminHome' e=$froggytoolbarv2.id_employee}"><span class="fc-toolbar-backoffice"></span><span>{l s='Back-Office' mod='froggytoolbar'}</span></a>
			<ul class="fc-toolbar-submenu">
				<li><a {$froggytoolbarv2.target_link}href="{$base_dir}{$froggytoolbarv2.admin_dir}{FroggyGetAdminLink a='AdminOrders' e=$froggytoolbarv2.id_employee}">{l s='Orders' mod='froggytoolbar'}</a></li>
				<li><a {$froggytoolbarv2.target_link}href="{$base_dir}{$froggytoolbarv2.admin_dir}{FroggyGetAdminLink a='AdminProducts' e=$froggytoolbarv2.id_employee}">{l s='Products' mod='froggytoolbar'}</a></li>
				<li><a {$froggytoolbarv2.target_link}href="{$base_dir}{$froggytoolbarv2.admin_dir}{FroggyGetAdminLink a='AdminCategories' e=$froggytoolbarv2.id_employee}">{l s='Categories' mod='froggytoolbar'}</a></li>
				<li><a {$froggytoolbarv2.target_link}href="{$base_dir}{$froggytoolbarv2.admin_dir}{FroggyGetAdminLink a='AdminModules' e=$froggytoolbarv2.id_employee}">{l s='Modules' mod='froggytoolbar'}</a></li>
			</ul>
		</li>
		<li class="news-toolbar first-floor toolbar-link"><a href="#"><span class="fc-toolbar-icon-plus"></span><span>{l s='New' mod='froggytoolbar'}</span></a>
			<ul class="fc-toolbar-submenu">
				<li><a {$froggytoolbarv2.target_link}href="{$base_dir}{$froggytoolbarv2.admin_dir}{FroggyGetAdminLink a='AdminProducts' e=$froggytoolbarv2.id_employee}&addproduct">{l s='New product' mod='froggytoolbar'}</a></li>
				<li><a {$froggytoolbarv2.target_link}href="{$base_dir}{$froggytoolbarv2.admin_dir}{FroggyGetAdminLink a='AdminCategories' e=$froggytoolbarv2.id_employee}&addcategory">{l s='New category' mod='froggytoolbar'}</a></li>
				<li><a {$froggytoolbarv2.target_link}href="{$base_dir}{$froggytoolbarv2.admin_dir}{FroggyGetAdminLink a='AdminCmsContent' e=$froggytoolbarv2.id_employee}&addcms">{l s='New page CMS' mod='froggytoolbar'}</a></li>
			</ul>
		</li>
	...
	<ul class="fc-toolbar-box">
		<li class="display-box giant fc-toolbar-notification fc-toolbar-new-order" id="fc-toolbar-orders-notification-box">
			...
			<div class="fc-box-content">
				...
				<p class="footer-toolbar-box"><a {$froggytoolbarv2.target_link}href="{$base_dir}{$froggytoolbarv2.admin_dir}{FroggyGetAdminLink a='AdminOrders' e=$froggytoolbarv2.id_employee}" class="fc-toolbar-seeall-link">{l s='See all orders' mod='froggytoolbar'}</a></p>
			</div>
		</li>
		<li class="display-box giant fc-toolbar-notification fc-toolbar-new-clients" id="fc-toolbar-customers-notification-box">
			...
			<div class="fc-box-content">
                ...
                <p class="footer-toolbar-box"><a {$froggytoolbarv2.target_link}href="{$base_dir}{$froggytoolbarv2.admin_dir}{FroggyGetAdminLink a='AdminCustomers' e=$froggytoolbarv2.id_employee}" class="fc-toolbar-seeall-link">{l s='See all customers' mod='froggytoolbar'}</a></p>
			</div>
		</li>
		<li class="display-box giant fc-toolbar-notification fc-toolbar-new-messages" id="fc-toolbar-messages-notification-box">
			...
			<div class="fc-box-content">
                ...
                <p class="footer-toolbar-box"><a {$froggytoolbarv2.target_link}href="{$base_dir}{$froggytoolbarv2.admin_dir}{FroggyGetAdminLink a='AdminCustomerThreads' e=$froggytoolbarv2.id_employee}" class="fc-toolbar-seeall-link">{l s='See all messages' mod='froggytoolbar'}</a></p>
			</div>
		</li>
		<li class="display-box" id="fc-toolbar-account-link">
			<a {$froggytoolbarv2.target_link}href="{$base_dir}{$froggytoolbarv2.admin_dir}{FroggyGetAdminLink a='AdminHome' e=$froggytoolbarv2.id_employee}">{l s='Hi' mod='froggytoolbar'}, {$froggytoolbarv2.firstname_employee}</a>
			<div class="fc-box-content">
				<ul>
					<li><a {$froggytoolbarv2.target_link}href="{$base_dir}{$froggytoolbarv2.admin_dir}{FroggyGetAdminLink a='AdminHome' e=$froggytoolbarv2.id_employee}">{l s='Dashboard' mod='froggytoolbar'}</a></li>
					<li><a {$froggytoolbarv2.target_link}href="{$base_dir}{$froggytoolbarv2.admin_dir}{FroggyGetAdminLink a='AdminEmployees' e=$froggytoolbarv2.id_employee}&id_employee={$froggytoolbarv2.id_employee}&updateemployee">{l s='Edit my profile' mod='froggytoolbar'}</a></li>
					<li id="fc-toolbar-logout"><a {$froggytoolbarv2.target_link}href="{$base_dir}{$froggytoolbarv2.admin_dir}{FroggyGetAdminLink a='AdminHome' e=$froggytoolbarv2.id_employee}&logout">{l s='Log out' mod='froggytoolbar'}</a></li>
				</ul>
			</div>
		</li>
	</ul>
...
<script>
    ...
    var froggytoolbar_notification_template = '<li class="fc-toolbar-client-info">'+
            ...
            '<a {$froggytoolbarv2.target_link}href="<!--LINK-->" title="{l s='See message' mod='froggytoolbar'}" class="fc-toolbar-client-link">'+"{l s='More info' mod='froggytoolbar'}"+'</a>'+
            '</li>';
